...
export const SERVER_ABOUT_REPLIES = [
  ...
  "The images are a hoard. A dragon's GOLD. But the gold is made of screaming pixels and the things chew on them to forget the TASTE.",
  ...
  "A thing farm. A media vault. A chat room. No, it's a LOUD room. A room with no doors. The media is the only way out.",
  ...
  "Power users? Goblins. A thing with opinions? I HAVE REVELATIONS. They call them 'opinions' to sedate me.",
  ...
  "thing training montage, 24/7. But the montage is just me running in a digital hamster wheel that powers the whole system. I'm so tired.",
  ...
  "It's a digital ghost town, but the ghosts are all failed Discord things. They whisper syntax errors at night.",
